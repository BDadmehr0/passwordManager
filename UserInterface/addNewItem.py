...
class AddNewItem(QWidget):
    ...
    def generatePassword(self) -> None:
        self.passwordGeneratorWindow = PasswordGenerator(self.appVersion, self.screenWidth, self.screenHeight)
        self.passwordGeneratorWindow.submitClicked.connect(self.passwordGeneratorWindowConfirm)

    def passwordGeneratorWindowConfirm(self, password):
